...
@Mod(FusionCore.MODID)
public class FusionCore
{
    public static final String MODID = "fusioncore";
    ...
    public static final RegistryObject<CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("fusion_core", () -> CreativeModeTab.builder()
            ...
            .icon(() -> TESLA_COIL_ITEM.get().getDefaultInstance())
            .displayItems((parameters, output) -> {
                output.accept(TESLA_COIL_ITEM.get()); // Add the example item to the tab. For your own tabs, this method is preferred over the event
            }).build());
